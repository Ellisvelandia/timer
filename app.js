...
let displayHrs = document.querySelector("#displayHrs");
let displayMins = document.querySelector("#displayMins");
let displaySecs = document.querySelector("#displaySecs");

let [days, hours, minutes, seconds] = [
  parseInt(displayDays.value),
  parseInt(displayHrs.value),
  parseInt(displayMins.value),
  parseInt(displaySecs.value),
];
...
function timer() {
  ...
  updateMinutes = Math.floor((TotalSeconds % 86400) / 60);
